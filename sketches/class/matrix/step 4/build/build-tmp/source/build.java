...
public void setup(){
	...
	pushMatrix();
		translate(100,height/2 - (70.711f/2) );
		rotate(radians(45));
		rect(0, 0, 50, 50);
	popMatrix();

	pushMatrix();
		translate(200,height/2 - (70.711f/2) );
		rotate(radians(45));
		rect(0, 0, 50, 50);
	popMatrix();

	pushMatrix();
		translate(300,height/2 - (70.711f/2) );
		rotate(radians(45));
		rect(0, 0, 50, 50);
	popMatrix();

	pushMatrix();
		translate(400,height/2 - (70.711f/2) );
		rotate(radians(45));
		rect(0, 0, 50, 50);
	popMatrix();

	pushMatrix();
		translate(500,height/2 - (70.711f/2) );
		rotate(radians(45));
		rect(0, 0, 50, 50);
	popMatrix();
